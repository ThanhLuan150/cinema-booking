...
vi.mock('../../api/owner.api', () => ({ getGiftCardHistory: (...args: unknown[]) => getGiftCardHistoryMock(...args) }));
...
describe('owner useGiftCardHistory', () => {
  ...
  it('fetches history for a given gift card id', async () => {
    ...
    expect(getGiftCardHistoryMock).toHaveBeenCalledWith(1, { page: 1, limit: 20 });
  });
