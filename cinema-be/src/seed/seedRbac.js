...
const PERMISSIONS = [
  ...
  ['distributor.read', 'distributor'], ['distributor.manage', 'distributor'],
  ['movieRelease.read', 'movieRelease'], ['movieRelease.manage', 'movieRelease'],
  ...
  ['campaign.read', 'campaign'], ['campaign.manage', 'campaign'], ['campaign.notify', 'campaign'],
  ['combo.create', 'combo'], ['combo.view', 'combo'], ['combo.update', 'combo'], ['combo.delete', 'combo'],
  ['review.view', 'review'], ['review.create', 'review'],
  ['review.update_own', 'review'], ['review.delete_own', 'review'], ['review.moderate', 'review'],
...
const BRANCH_ADMIN_PERMISSIONS = {
  ...
  'campaign.read': 'BRANCH', 'campaign.manage': 'BRANCH', 'campaign.notify': 'BRANCH',
