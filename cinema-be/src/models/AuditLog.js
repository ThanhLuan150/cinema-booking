...
const ACTION = {
  ...
  CAMPAIGN_NOTIFICATION_SENT: 'CAMPAIGN_NOTIFICATION_SENT',
  CAMPAIGN_BANNER_CREATED: 'CAMPAIGN_BANNER_CREATED',
  CAMPAIGN_BANNER_UPDATED: 'CAMPAIGN_BANNER_UPDATED',
  CAMPAIGN_BANNER_DELETED: 'CAMPAIGN_BANNER_DELETED',

  // Private Event & Cinema Rental (Ticket 40)
  PRIVATE_EVENT_REQUESTED: 'PRIVATE_EVENT_REQUESTED',
  PRIVATE_EVENT_QUOTED: 'PRIVATE_EVENT_QUOTED',
  PRIVATE_EVENT_APPROVED: 'PRIVATE_EVENT_APPROVED',
  PRIVATE_EVENT_PAID: 'PRIVATE_EVENT_PAID',
  PRIVATE_EVENT_CONFIRMED: 'PRIVATE_EVENT_CONFIRMED',
  PRIVATE_EVENT_COMPLETED: 'PRIVATE_EVENT_COMPLETED',
  PRIVATE_EVENT_CANCELLED: 'PRIVATE_EVENT_CANCELLED',

  // Employee Attendance (Ticket 43)
  ...
  // Supplier & Purchase Order (Ticket 46)
